CLASS zcl_rap100_gen_data_sri DEFINITION
 PUBLIC
  FINAL
  CREATE PUBLIC .
...
CLASS zcl_rap100_gen_data_sri IMPLEMENTATION.

  METHOD if_oo_adt_classrun~main.
    DATA:
      group_id   TYPE string VALUE 'SRI',
      attachment TYPE /dmo/attachment,
      file_name  TYPE /dmo/filename,
      mime_type  TYPE /dmo/mime_type.

*   clear data
    DELETE FROM zrap100_atravsri.
*    DELETE FROM zrap100_dtrav###.

    "insert travel demo data
    INSERT zrap100_atravsri  FROM (
        SELECT
